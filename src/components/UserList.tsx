  ...
  return (
    <div className="space-y-6">
      ...
      <ConfirmationModal 
        ...
        title="Remove User"
        message={`Are you sure you want to completely remove ${userToDelete?.fullName} and all their related data? This action cannot be undone.`}
...
function ClientRow({ user, agents, currentUser, assignAgent, updateApplicationStatus, updateUser, rejectAgentRequest, setActiveTab, setSelectedUserProfileId, STAGES, onDelete }: any) {
        ...
        {user.requestedAgentId ? (
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-2.5 text-vibrant-yellow bg-vibrant-yellow/10 px-3 py-1.5 rounded-xl border border-vibrant-yellow/20 w-fit">
              ...
              <span className="text-[10px] font-black uppercase tracking-widest">Requested: {requestedAgent?.fullName}</span>
            </div>
            {isAdmin && (
              <div className="flex flex-wrap gap-2">
                ...
                <select
                  ...
                  value=""
                >
                  <option value="" className="bg-card">Assign Different</option>
        ...
        <div className="flex items-center justify-end gap-2.5">
          {isAdmin && user.approvalStatus === 'PENDING' && (
            <button
              ...
              className="px-3 py-2 text-[10px] font-black uppercase tracking-widest rounded-xl bg-vibrant-green text-white hover:opacity-90 transition-all active:scale-95"
