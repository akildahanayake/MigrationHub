...
function ClientRow({ user, agents, currentUser, assignAgent, updateApplicationStatus, rejectAgentRequest, setActiveTab, setSelectedUserProfileId, STAGES, onDelete }: any) {
