...
export default function Dashboard() {
  const { currentUser, users, documents, meetings, payments, setActiveTab, setSelectedUserProfileId, pipelineStages, notifications, markNotificationAsRead } = useStore();
